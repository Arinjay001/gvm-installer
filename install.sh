...
info "Configuring Universal Nginx Reverse Proxy..."
...
info "Cleaning up old ttyd processes..."
pkill -f ttyd || true
...
info "Configuring console template..."
...
<head>
    ...
    <style>
        body, html { margin: 0; padding: 0; height: 100%; background-color: #09090b; font-family: 'Inter', sans-serif; color: #ffffff; overflow: hidden; }
        ...
        .title i { color: #6366f1; }
        .status-badge { background-color: rgba(16, 185, 129, 0.1); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.3); padding: 4px 10px; border-radius: 4px; font-size: 11px; font-weight: 700; display: flex; align-items: center; gap: 6px; }
        ...
        .btn { padding: 8px 16px; border: none; border-radius: 4px; font-size: 13px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px; text-decoration: none; }
...
<body>
    ...
    <script>
        function disconnectTerminal() {
            ...
            badge.innerHTML = `<div class="dot" style="background-color: #ef4444;"></div> DISCONNECTED`;
...
echo -e "${GREEN}"
echo "╔════════════════════════════════════════════════════════════╗"
echo "║             GVM PANEL INSTALLATION SUCCESSFUL              ║"
echo "╚════════════════════════════════════════════════════════════╝"
